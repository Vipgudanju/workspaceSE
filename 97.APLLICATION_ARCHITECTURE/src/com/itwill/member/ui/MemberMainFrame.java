...
public class MemberMainFrame extends JFrame {
	...
	*/
	...
	public MemberMainFrame()throws Exception {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"류주현", "권은영", "권나라", "오나라"}));
		...
		list.setModel(new AbstractListModel() {
			String[] values = new String[] {"류주현", "권은영", "권나라", "오나라", "류주현", "권은영", "권나라", "오나라", "류주현", "권은영", "권나라", ""};
			public int getSize() {
	...
	private void displayMemberList() {
		...
		try {
			...
			memberDeleteBtn.setEnabled(false);
			//memberListTB.setRowSelectionInterval(selected_index,selected_index);
