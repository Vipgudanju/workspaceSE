...
public class wrapperClass유용한메소드 {
	...
	public static void main(String[] args) {
		...
		if(wc1 == wc2) {
			...
			System.out.println("wc1 != wc2 주소동일하지 않음");
		}
		*/
		/*
		 * Wrapper 객체의 값비교는 equals메소드를 사용해야한다.
		 */
		if(wc1.equals(wc2 )) {
			System.out.println("Wc1객체의 char값과 wc2객체의 char값이 동일하다.");
		}
		
		String strs = "Hello Java!!^~ $%^$%^$% ++123215213 장원영 안유진";
