...
public class wrapperClassMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("**************** AUTO BOXING, 자동 형변환 *******************");
