...
public class user_js {
	...
	public user_js(String user_id, String user_pw ,String user_name, String user_phone, String user_address, String user_email) {
		super();
	...
	public String toString() {
		return "user_js [user_id=" + user_id + ", user_pw=" + user_pw + ", user_name=" + user_name + ", user_phone="
