...
public class userDao_jsTestMain {
	...
	public static void main(String[] args) throws Exception{
		...
		System.out.println("1.insert   --> "+userDao.insert(new user_js("book1", "4444", "장원영", "010-4444-4444", "경기도 구리시", "book4@korea.com")));
		System.out.println("2.update   --> "+userDao.update(new user_js("book1", "3333", "윤보미", "010-3434-3434", "서울시 중랑구", "book5@korea.com")));
