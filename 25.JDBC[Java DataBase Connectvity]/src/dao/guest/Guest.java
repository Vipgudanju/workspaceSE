...
public class Guest {
	...
	public Guest(int guest_no, String guest_name, int guest_date, String guest_email, String guest_homepage,
	...
	public int getGuest_date() {
		return guest_date;
	}

	public void setGuest_date(int guest_date) {
		this.guest_date = guest_date;
	}
